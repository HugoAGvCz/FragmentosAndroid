...
class Fragmento3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_fragmento3, container, false)

        val btnFragmento1 = view.findViewById<Button>(R.id.desplFragmento1)
        btnFragmento1.setOnClickListener {
            (activity as MainActivity).cambiarFragmento1()
        }
